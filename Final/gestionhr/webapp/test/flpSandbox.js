		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Arrancamos...",
									"targetURL": "#logaligroupgestionhr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupgestionhr-display": {
								"semanticObject": "logaligroupgestionhr",
								"action": "display",
								"description": "Gestion HR",
								"title": "Arrancamos...",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.gestionhr",
									"url": sap.ui.require.toUrl("logaligroup/gestionhr")
								}
							}
						}
					}
