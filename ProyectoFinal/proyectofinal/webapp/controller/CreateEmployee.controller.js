sap.ui.define([
    ...
    function onBeforeRendering() {
        ...
        //Modelo principal que tiene los datos
        this._model = new sap.ui.model.json.JSONModel({});
        this.getView().setModel(this._model);
        //Se reinicia por si ya se ha ejecutado antes
    ...
    function gotoStep2(oEvent) {
        ...
        //Obtener el tipo seleccionado con el "CustomData"
        var button = oEvent.getSource();
        var typeEmployee = button.data("typeEmployee");

        //Salario bruto por defecto dependiendo del tipo: gerente: 70000 interno: 24000 autonomo: 400
        var Salary, Type;
        switch (typeEmployee) {
            case "gerente":
                Salary = 70000;
        ...
        //Se comprueba si está en el paso 1, ya que debe usar la función "nextStep" para ir al paso 2.
    ...
    //Función botón editar "Tipo de empleado"
    function editStepOne() {
        _editStep.bind(this)("typeEmployeeStep");
    }

    //Función botón editar "Datos de empleado"
    function editStepTwo() {
        _editStep.bind(this)("dataEmployeeStep");
    }

    //Función botón editar "Información adicional"
    ...
    function onSaveEmployee() {
        ...
        var body = {};
        //Se obtienen aquellos campos que no empiezan por "_", ya que son los que vamos a enviar
        for (var i in json) {
            if (i.indexOf("_") !== 0) {
                body[i] = json[i];
            }
