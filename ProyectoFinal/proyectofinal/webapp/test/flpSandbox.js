		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Empleados",
									"targetURL": "#logaligroupproyectofinal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupproyectofinal-display": {
								"semanticObject": "logaligroupproyectofinal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.proyectofinal",
									"url": sap.ui.require.toUrl("logaligroup/proyectofinal")
								}
							}
						}
					}
